...
urlpatterns = [
    ...
    path('promotions/', views.PromotionListAPIView.as_view(), name='api-promotions'),
    path('reviews/', views.ReviewListAPIView.as_view(), name='api-reviews'),
    path('equipment/', views.EquipmentListAPIView.as_view(), name='api-equipment'),
    path('callback-requests/', views.CallbackRequestListCreateAPIView.as_view(), name='api-callback-requests'),
